...
# In/out-of-bbox abs_rel split across the v5 retrain (LR=1e-5 experiment,
# train_lotus_d_object_bbox_loss_v5.ps1). Same checkpoint grid as v2/v3/v4.
$DETAIL_MODEL = "output/train-lotus-d-object-bbox-lora-v5"
$REGRESSOR = "output/object_depth_regressor_v5_roi"
$ARTIFACTS = "D:/lotus/data/nyuv2_detail_artifacts/test"
$OUT_ROOT = "output/eval_bbox_split_object_bbox_lora_v5"
